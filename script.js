...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const employmentHistory = [
        { id: 1, title: 'Principal/Chief Technologist', company: 'Academy of Saut Ul Furqan', years: '2018 - Present', description: 'Design and architect enterprise network solutions' },
        { id: 2, title: 'Mobility Lead, Deskside / Lab Support Specialist', company: 'Novartis Institute for Biomedical Research', years: '2016 - 2018', description: 'Provide consultation to NYC public sector customer' },
        { id: 3, title: 'Client-Endpoint Specialist', company: 'Fresenius Medical Care', years: '2009 - 2016', description: 'Provide guidance to global finance customers' }
